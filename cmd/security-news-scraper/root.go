...
var rootCmd = &cobra.Command{
	Use:          "security-news-scraper",
	Short:        "Security news and CVE aggregation engine",
	Long:         "Security-news-scraper aggregates cybersecurity news, enriches CVEs with NVD, CISA KEV, and EPSS intelligence, clusters stories across outlets, and ranks what matters.",
	SilenceUsage: true,
}
