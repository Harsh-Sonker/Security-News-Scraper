...
import (
	...
	"github.com/Harsh-Sonker/security-news-scraper/internal/enrich"
	...
	"github.com/Harsh-Sonker/security-news-scraper/internal/watch"
)
...
var watchCmd = &cobra.Command{
	...
	Long: "Run security-news-scraper as a long-lived daemon that re-ingests every enabled source on an interval " +
