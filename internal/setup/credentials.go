...
const (
	EnvProvider = "SECURITY_NEWS_SCRAPER_AI_PROVIDER"
	EnvQwenURL  = "SECURITY_NEWS_SCRAPER_QWEN_BASE_URL"

	commentMark = "#"
	kvSeparator = "="

	credentialKeyPrefix = "SECURITY_NEWS_SCRAPER_"
	credentialKeySuffix = "_API_KEY"
	tmpSuffix           = ".tmp"

	credentialsHeader = "# ©Harsh Sonker | 2026\n# security-news-scraper credentials — auto-managed by `security-news-scraper ai`; keep private, do not commit\n\n"
)
